    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($row) {
                return '<a href="/PWL_POSelis/public/barang/edit/' . $row->barang_id . '"class="btn btn-primary ">Edit</a>
                        <a href="/PWL_POSelis/public/barang/delete/' . $row->barang_id . '"class="btn btn-primary ">Delete</a>';
            })
            ->setRowId('id');
    }
